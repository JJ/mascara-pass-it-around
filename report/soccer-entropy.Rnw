...
\item[RQ1] Is some way of entropy able to describe the team behavior in a single measurement?
\item[RQ2] Is some way of entropy correlated with any description of success in the game?
...
\item[RQ4] Is individual-level entropy able to describe the team in an invariant or predictably variant way?
