...
\\
JJ Merelo\textsuperscript{1,\Yinyang},
\\
\bigskip
...
This data was used for Elena Merelo's BEng/BSc thesis \cite{MERELO2022}, which focused on England (the winner) and Norway (which was defeated 8-0 by England in an upset match).
